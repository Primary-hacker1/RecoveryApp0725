...
public class WaveShowView extends View {
    ...
    private float WAVE_LINE_STROKE_WIDTH = 4f;
    private int mWaveLineColor = Color.parseColor("#3E99D2");//波形颜色
    ...
    private final int GRID_LINE_WIDTH = 1;//网格的线的宽度
    private int mWaveSmallLineColor = Color.parseColor("#a9a9a9");//小网格颜色
    private int mWaveBigLineColor = Color.parseColor("#000000");//小网格颜色
    ...
    private void drawWaveLine(Canvas canvas) {
        try {
            ...
            for (int i = 0; i < refreshList.size(); i++) {
                ...
                nowY = mHeight / 2 + dataValue * (mHeight / (MAX_VALUE * 1.8f));
            ...
            Log.d("drawWaveLine", e.getMessage());
        }
    }
