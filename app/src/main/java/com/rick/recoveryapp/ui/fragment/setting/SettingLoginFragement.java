...
import com.rick.recoveryapp.ui.activity.SettingActivity;
...
public class SettingLoginFragement extends Fragment {
    ...
    public void initClinck() {
        ...
        binding.settingloginBtnUpdate.setOnClickListener(v -> DialogLoader.getInstance().showInputDialog(
        ...
        binding.settingloginBtnSave.setOnClickListener(v -> {
