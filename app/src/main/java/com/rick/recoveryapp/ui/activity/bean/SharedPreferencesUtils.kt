...
class SharedPreferencesUtils private constructor() {
    ...
    companion object {
        ...
        private const val NUMBER = "per_user_number"
        private const val PHONE = "per_user_phone"
        private const val ADDRESSBEAN = "per_user_addressBean"
    }
    ...
    var number: String? = null
        get() {
            if (field == null) {
                field = CommonSharedPreferences.getSPValue(NUMBER, "")
            }
            return field
        }
        set(serialNo) {
            field = serialNo
            CommonSharedPreferences.setSPValue(NUMBER, serialNo)
        }
    ...
    var phone: String? = null
        ...
        set(phone) {
            field = phone
            CommonSharedPreferences.setSPValue(PHONE, phone)
        }

    var addressString: AddressBean? = null
        get() {
            if (field == null) {
                val jsonStr = CommonSharedPreferences.getSPValue(ADDRESSBEAN, "")

                if(jsonStr.isEmpty()){
                    return field
                }
                val gson = Gson()
                val person: AddressBean = gson.fromJson(jsonStr, AddressBean::class.java)
                field = person
            }
            return field
        }
    ...
    fun logout() {
        ...
        instance.number = ""
        instance.phone = ""
        instance. addressString = AddressBean()
        CommonSharedPreferences.setSPValue(NAME, "")
        CommonSharedPreferences.setSPValue(NUMBER, "")
        CommonSharedPreferences.setSPValue(PHONE, "")
        CommonSharedPreferences.setSPValue(ADDRESSBEAN, "")
    }
...
object CommonSharedPreferences {
    ...
    fun <T> setSPValue(key: String, value: T) {
        val mShareConfig = BaseApplication.getContext().getSharedPreferences(USER, Context.MODE_PRIVATE)
        put(mShareConfig, key, value)
    }
